#!/usr/bin/env python
# Created by "Thieu" at 17:21, 06/11/2024 ----------%                                                                               
...
classifiers = {
    ...
    "FLNN": FlnnClassifier(expand_name="chebyshev", n_funcs=4, act_name="sigmoid",
                   obj_name="BCEL", max_epochs=750, batch_size=64, optimizer="SGD", verbose=False)
}
